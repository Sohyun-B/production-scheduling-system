...
**함수**: `create_results()` ⭐ 변경됨 (기존: create_results)
...
1. **스케줄링*성과*지표**: PO수, makespan, 납기준수율, 평균가동률
2. **호기\_정보**: 기계별 작업 스케줄
3. **장비별*상세*성과**: 기계별 가동률, 가동시간, 작업 수
